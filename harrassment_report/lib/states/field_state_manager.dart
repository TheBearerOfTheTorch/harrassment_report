...
/// Handle Application fields control states
class FieldsStateManager extends ChangeNotifier {
  ...
  //gender get controller
  get regGenderController => _gender;
  bool get isGenderNull => _isGenderNull;

  //date of birth get controllers
  get regDayOfBirthController => _dateOfBirth1;
  get regMonthOfBirthController => _dateOfBirth2;
  get regYearOfBirthController => _dateOfBirth3;
  ...
  set birthdayController(value) {
    _dateOfBirth1 = value;
    notifyListeners();
  }

  set birthMonthController(value) {
    _dateOfBirth2 = value;
    notifyListeners();
  }

  set birthYearController(value) {
    _dateOfBirth3 = value;
    notifyListeners();
  }

  //gender setter and checks
  set setGenderController(value) {
    _gender = value;
    notifyListeners();
  }
